...
$groupMappings = @(
  ...
  @(@('print operators', 'opers. de impresion'), 'S-1-5-32-550'),
  @(@('backup operators', 'operadores de copia de seguridad'), 'S-1-5-32-551'),
  @(@('replicators', 'duplicadores'), 'S-1-5-32-552'),
  @(@('network configuration operators', 'operadores de configuracion de red'), 'S-1-5-32-556'),
  ...
  @(@('cryptographic operators', 'operadores criptograficos'), 'S-1-5-32-569'),
  ...
  @(@('rds management servers', 'servidores de administracion rds'), 'S-1-5-32-577'),
  ...
  @(@('remote management users', 'usuarios de administracion remota'), 'S-1-5-32-580'),
